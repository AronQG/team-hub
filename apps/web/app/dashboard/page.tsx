    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Welcome back, {session?.name}! Here's what's happening in your workspace.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link href="/dashboard/chats" className="font-medium text-blue-700 hover:text-blue-900">
                View all chats
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link href="/dashboard/kanban" className="font-medium text-green-700 hover:text-green-900">
                View kanban board
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link href="/dashboard/files" className="font-medium text-purple-700 hover:text-purple-900">
                View all files
              </Link>
            </div>
          </div>
          ...
          <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500">Create a new conversation</p>
              </div>
            </Link>
        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="mt-5">
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">Get started by creating your first chat or task.</p>
            </div>
          </div>
        </div>
      </div>
